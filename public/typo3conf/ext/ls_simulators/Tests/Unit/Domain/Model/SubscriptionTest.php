<?php
namespace Simulators\LsSimulators\Tests\Unit\Domain\Model;
...
{
    /**
     * @var \Simulators\LsSimulators\Domain\Model\Subscription
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Simulators\LsSimulators\Domain\Model\Subscription();
    }
